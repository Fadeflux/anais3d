...
const CDN = [{"url":"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2.116.0/dist/umd/supabase.min.js","cors":true},{"url":"https://cdn.jsdelivr.net/npm/chart.js@4.5.1/dist/chart.umd.min.js","cors":true},{"url":"https://cdn.jsdelivr.net/npm/jszip@3.10.2/dist/jszip.min.js","cors":true},{"url":"https://cdn.jsdelivr.net/npm/qrcode-generator@2.0.4/dist/qrcode.js","cors":true},{"url":"https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js","cors":true}];
    ...
    if (req.mode === 'navigate') {
      event.respondWith((async () => {
        ...
        try {
          ...
          return new Response(`<p style="font-family:system-ui;padding:24px">${"Anais3D : pas de connexion et application pas encore installée sur cet appareil."}</p>`, { status: 503, headers: { 'Content-Type': 'text/html; charset=utf-8' } });
        }
      })());
      return;
    }
